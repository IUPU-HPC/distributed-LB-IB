...
int global2task(int X, int Y, int Z, GV gv){
	...
	// rank_y = BJ / cubes_per_task_y;
	// rank_x = BI / cubes_per_task_x;
	int dst_task = (BI / cubes_per_task_x) * num_fluid_task_y * num_fluid_task_z 
...
int global2task_and_thread(int X, int Y, int Z, GV gv, int *dst_task){
	...
	*dst_task = (BI / cubes_per_task_x) * num_fluid_task_y * num_fluid_task_z 
	...
	int Block_size_x  =  cubes_per_task_x / tx;
 	...
 	int i = (BI % cubes_per_task_x) / Block_size_x;
	int j = (BJ % cubes_per_task_y) / Block_size_y;
	int k = (BK % cubes_per_task_z) / Block_size_z;
